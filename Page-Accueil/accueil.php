...
<head>
    ...
    <meta name="description"
        content="Découvrez les services professionnels de vente et de réparation automobile de Vincent Parrot !">
                ...
                <div class="col-sm-6 col-md-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Notre garage automobile est votre solution de confiance pour toutes
                                réparations et entretiens de votre véhicule car notre objectif et de satisfaire notre
                                clientèle.</p>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#modalComment">Voir les commentaires de nos clients</button>
                            <a href="../espace_employés/publierCommentaire.php" class="btn btn-primary">Laisser un
                                commentaire</a>
                ...
                <div class="col-sm-6 col-md-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Notre atelier est parfaitement équipé pour vous permettre de rouler en
                                toute sécurité.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Pour l'achat de vos véhicules, vous trouverez des vendeuses et vendeurs
                                à votre écoute pour vous satisfaire.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-md-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#exampleModal">Voir nos prestations</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer class="footer">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6  bg-warning">
                ...
                <ul>
                    <li>LUNDI :
                        <?php echo isset($resultHoraires['lundi']) ? $resultHoraires['lundi'] : 'Non disponible'; ?>
                    </li>
                    <li>MARDI :
                        <?php echo isset($resultHoraires['mardi']) ? $resultHoraires['mardi'] : 'Non disponible'; ?>
                    </li>
                    <li>MERCREDI :
                        <?php echo isset($resultHoraires['mercredi']) ? $resultHoraires['mercredi'] : 'Non disponible'; ?>
                    </li>
                    <li>JEUDI :
                        <?php echo isset($resultHoraires['jeudi']) ? $resultHoraires['jeudi'] : 'Non disponible'; ?>
                    </li>
                    <li>VENDREDI :
                        <?php echo isset($resultHoraires['vendredi']) ? $resultHoraires['vendredi'] : 'Non disponible'; ?>
                    </li>
                    <li>SAMEDI :
                        <?php echo isset($resultHoraires['samedi']) ? $resultHoraires['samedi'] : 'Non disponible'; ?>
                    </li>
                    <li>DIMANCHE :
                        <?php echo isset($resultHoraires['dimanche']) ? $resultHoraires['dimanche'] : 'Non disponible'; ?>
                    </li>
                </ul>
            ...
            <div class="col-sm-6 col-md-6 bg-warning">
                ...
                <P><br>
                    ...
                    ADRESSE EMAIL : parrot.v75@gmail.com
                    <br><br>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <p class="copyright">Garage V.parrot Copyright 2023 <a href="../MentionsLegales/MentionsLegales.html"
                target="_blank">Mentions Légales</a> | <a href="../MentionsLegales/RGPD.html" target="_blank">Politique
